...
var SelectedOption = function SelectedOption(_ref2) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      "div",
      { "data-flume-component": "select-icon-container", className: styles$8.selectedWrapperIcon },
      React__default.createElement(
        "svg",
        { fill: "currentColor", "aria-hidden": "true", width: "20", height: "20", viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg" },
        React__default.createElement("path", { d: "M15.85 7.65c.2.2.2.5 0 .7l-5.46 5.49a.55.55 0 01-.78 0L4.15 8.35a.5.5 0 11.7-.7L10 12.8l5.15-5.16c.2-.2.5-.2.7 0z", fill: "currentColor" })
      )
    )
  );
};
...
var Control = function Control(_ref) {
  ...
  var getControlByType = function getControlByType(type) {
    ...
    switch (type) {
      ...
      case "number":
        return React__default.createElement(TextInput, _extends({}, commonProps, {
          step: step,
          minValue: minValue,
          maxValue: maxValue,
          type: "number",
